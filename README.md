# Meta's Messenger Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Meta's Messenger Trademarks Logo. They published clear trademark guideline
but and did supplied the required material files for it. The preferred version
is `.svg` which has non-destructive scale up & down properties and can be
converted into any rasterized images (e.g. `jpeg`, `webp`, `avif`, etc). To
comply with our standards, a re-draw is required.

This project re-draws Meta's Messenger Trademarks Logo specifically for
1200x1200 size.
...
Since Meta's Messenger published clear brand and trademark guideline, **you MUST
read through all the following to avoid any unwanted legal implications**:

* https://www.meta.com/brand/resources/facebook/messenger-icon

While not specified by Meta's Messenger, please ensure the outputs are also web
ready. Refer:
...
```
--------------------------------------------------------------------------------
Title: Meta's Messenger Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-metamessenger-1200x1200
UUID: 9C4F7315-2C20-444C-80BE-C282D997C0A2
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-19
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-metamessenger-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH META'S MESSENGER TRADEMARK REQUIREMENTS
> (Refer: https://www.meta.com/brand/resources/facebook/messenger-icon)**.
>
